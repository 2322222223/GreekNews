...
public class IosFragment extends BaseFragment<ZhiHuView, ZhiHuPresenter<ZhiHuView>> implements ZhiHuView {
        ...
        if (mAdapter != null) {
            mAdapter.setOnItemClickListener(new GanHuoAdapter.OnItemClickListener() {
                ...
                public void OnItemClick(int poisiton) {
                    ...
                    if (mAdapter.mList.get(poisiton).getImages().size() > 0) {
                    ...
                    intent.putExtra("type", Constants.TYPE_IOS);
    ...
    protected void initAdapter() {
        ...
        mRecyclerviewIos.setAdapter(mAdapter);
    }
    ...
    protected void initView(View view) {
        ...
        mRecyclerviewIos = (PullLoadMoreRecyclerView) view.findViewById(R.id.recyclerview_ios);
        mRecyclerviewIos.setLinearLayout();
    }
